...
export function printCrawlHelp(): void {
  const lines = [
    ...
    "",
    "Options:",
    `  -d, --max-depth <n>      Max crawl depth from start (default: ${DEFAULT_OPTIONS.maxDepth})`,
    `  -p, --max-pages <n>      Max pages to fetch during crawl (default: ${DEFAULT_OPTIONS.maxPages})`,
    `      --delay <ms>         Minimum delay between requests (default: ${DEFAULT_OPTIONS.delayMs})`,
    `  -o, --output <path>      Output directory (default: ${DEFAULT_OPTIONS.outDir})`,
    `  -c, --concurrency <n>    Parallel workers (default: ${DEFAULT_OPTIONS.concurrency})`,
    `  -t, --timeout <ms>       Fetch timeout in ms (default: ${DEFAULT_OPTIONS.timeoutMs})`,
    `      --retries <n>        Retry attempts (default: ${DEFAULT_OPTIONS.retries})`,
    "  -a, --user-agent <str>   Custom User-Agent header",
    "",
    `  -v, --[no-]verbose       Enable/disable verbose logging (default: ${DEFAULT_OPTIONS.verbose})`,
    `  -r, --[no-]robots        Respect/ignore robots.txt (default: ${DEFAULT_OPTIONS.respectRobots})`,
    `      --[no-]render        Enable/disable headless rendering for SPAs (default: ${DEFAULT_OPTIONS.render})`,
    `      --[no-]progress      Show/hide progress bar (default: ${DEFAULT_OPTIONS.progress})`,
    `      --[no-]overwrite     Overwrite existing .llms.md files (default: ${DEFAULT_OPTIONS.overwriteLlms})`,
    `      --[no-]clutter       Write .clutter.md output (default: ${DEFAULT_OPTIONS.clutter})`,
    "",
...
export function printFindHelp(): void {
  const lines = [
    ...
    "",
    "Options:",
    `  -d, --directory <path>   Directory to search (default: ${DEFAULT_FIND_OPTIONS.directory})`,
    `      --files-only         Only search file paths (default: ${DEFAULT_FIND_OPTIONS.filesOnly})`,
    `      --content-only       Only search file content (default: ${DEFAULT_FIND_OPTIONS.contentOnly})`,
    `  -l, --limit <n>          Max results to show (default: ${DEFAULT_FIND_OPTIONS.limit})`,
    `  -C, --context <n>        Lines of context around matches (default: ${DEFAULT_FIND_OPTIONS.contextLines})`,
    "",
    "  -h, --help               Show this help",
    "",
    "Examples:",
...
export function printLinkCheckHelp(): void {
  const lines = [
    ...
    "",
    "Options:",
    `  -o, --output <path>      Docs directory (default: ${DEFAULT_OPTIONS.outDir})`,
    `  -v, --[no-]verbose       Enable/disable verbose logging (default: ${DEFAULT_OPTIONS.verbose})`,
    "",
    "  -h, --help               Show this help",
    "",
